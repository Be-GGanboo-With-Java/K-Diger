...
//
//class Solution {
//    public void solution(String[] strings, int n) {
//
//        int max = -1;
//        int priorityIndex = 0;
//
//        for (int i = 0; i < strings.length; i ++) {
//            if (max < (int) strings[i].charAt(n)) {
//                max = strings[i].charAt(n);
//                priorityIndex = i;
//            }
//        }
//
//        ArrayList<String> result = Arrays.stream(strings).sorted(Comparator.comparing()).toList();
//    }
//}
//
//
